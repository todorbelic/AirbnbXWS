...
const (
	...
	AccommodationServiceRPC_SearchAcommodations_FullMethodName  = "/AccommodationServiceRPC/SearchAcommodations"
...
func (c *accommodationServiceRPCClient) SearchAcommodations(ctx context.Context, in *SearchAcommodationsRequest, opts ...grpc.CallOption) (*SearchAcommodationsResponse, error) {
	out := new(SearchAcommodationsResponse)
	err := c.cc.Invoke(ctx, AccommodationServiceRPC_SearchAcommodations_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAccommodationServiceRPCServer) SearchAcommodations(context.Context, *SearchAcommodationsRequest) (*SearchAcommodationsResponse, error) {
...
func _AccommodationServiceRPC_SearchAcommodations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchAcommodationsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccommodationServiceRPCServer).SearchAcommodations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccommodationServiceRPC_SearchAcommodations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccommodationServiceRPCServer).SearchAcommodations(ctx, req.(*SearchAcommodationsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccommodationServiceRPC_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AccommodationServiceRPC_SearchAcommodations_Handler,
		},
		{
